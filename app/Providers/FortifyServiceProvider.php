...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        $this->app->when([AdminLoginController::class, AdminAttemptToAuthenticate::class, AdminRedirectIfTwoFactorAuthenticatable::class,])->needs(StatefulGuard::class)->give(function () {
